...
INSERT INTO acl_resource VALUES (2,'acl_group','Administracion de ACLs de grupos');
...
INSERT INTO acl_user VALUES (6,'micho','Michito Lindo','76b687e46209bf9d0f149f96a1a708fc');
INSERT INTO acl_user VALUES (5,'gata','Peluche en pata','e619e8aedaf0e34487f80219a8fbb85d');
INSERT INTO acl_user VALUES (7,'perro','Soy un perro','d44b121fc3524fe5cdc4f3feb31ceb78');
...
CREATE TABLE IF NOT EXISTS ul_alumno_materia  (
  ...
  estatus enum('A','I') NOT NULL default 'A',
  aprobada enum('S','H','N') NOT NULL default 'N',
