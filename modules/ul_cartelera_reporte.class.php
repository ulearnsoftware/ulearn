...
// +----------------------------------------------------------------------+
//
// $Id: ul_cartelera_reporte.class.php,v 1.4 2004/10/26 20:31:41 jgallegos Exp $
...
class ul_cartelera_reporte extends PaloReporte{
   ...
   function ul_cartelera_reporte(&$oDB, &$oPlantillas, $sBaseURL, $id_materia_periodo_lectivo,$id_cartelera)
   {
      ...
      $const_where = "final>=NOW() ";
      if($id_materia_periodo_lectivo!=NULL)
         $const_where .= "UNION (SELECT id_evento,titulo,contenido,creacion,".
      ...
      if (!$this->definirReporte("LISTA_CARTELERAS", array(
         ...
         "DATA_COLS"     =>  array(
                                 ...
                                 "INICIO"=>"inicio",
                                 "FINAL"=>"final",
                                 "ID_CALIFICABLE"=>"'' as id_calificable",
                                 "TIPO"=>"'C' as tipo",
                                 "ID_MATERIA_PERIODO_LECTIVO"=>"'0' as id_materia_periodo_lectivo",
                                 "VACIO"=>"'' as vacio",
                             ),
         "PRIMARY_KEY"   =>  array("ID"),
         "FROM"          =>  "ul_cartelera",
         "CONST_WHERE"   =>  $const_where,
         "ORDERING"      =>  array(
