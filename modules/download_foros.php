...
// +----------------------------------------------------------------------+
//
// $Id: download_foros.php,v 1.1 2004/11/09 01:04:11 ainiguez Exp $
session_start();
$gsRutaBase="..";
...
function _moduleContent(&$pDB, &$_GET, &$_POST)
{
    ...
    //Si existe un session_user se continua
      if($login!=""){
         $id_mensaje_archivo=recoger_valor("id",$_GET,$_POST,"");

            if($id_mensaje_archivo!=""){
               ...
               $oDownload =& new ul_download_foro($insDB,$insTpl,$id_mensaje_archivo,$login);
